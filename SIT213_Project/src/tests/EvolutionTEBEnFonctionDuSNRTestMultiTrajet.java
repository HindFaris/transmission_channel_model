...
public class EvolutionTEBEnFonctionDuSNRTestMultiTrajet {
	private final static String CHEMIN = "C:\\Users\\33663\\Documents\\2eme année ing\\SIT200\\SIT213\\evolution_TEB_SNR.txt";	//Please respect this format
	...
	public static void main(String[] args) throws ArgumentsException, Exception{
		...
		System.out.println("SNR par bit (dB);NRZ sans multitrajet;NRZ multitrajet (A=0.9, dt=30) et (A=1, dt=20) ;NRZ multitrajet (A=0.2, dt=30) et (A=0.3, dt=20)");
		for(float indice = -50; indice<=20; indice += 1) {
			...
			Simulateur simulateurNRZT =  new Simulateur(new String[] {"-mess","100000", "-form", "NRZ", "-snrpb", String.valueOf(indice),"-ti","20","0.9", "20","1"});
			simulateurNRZT.execute();
			Simulateur simulateurRZ =  new Simulateur(new String[] {"-mess","100000", "-form", "NRZ", "-snrpb", String.valueOf(indice),"-ti","20","0.5","20","0.4"});
