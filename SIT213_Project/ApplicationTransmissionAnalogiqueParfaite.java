...
import Transmetteur.TransmetteurAnalogique;

public class ApplicationTransmissionAnalogiqueParfaite {


    /**
     * Main de lancement de l'etape 2
     *
     * @param args : 7 parametres
     */
    ...
    public static TransmetteurAnalogique transmetteurAnalogique;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (sonde) {
                 sondeLogiqueEntree = new SondeLogique(
                        "Sonde Logique Entree");
                 sondeLogiqueSortie = new SondeLogique(
                        "Sonde logique du recepteur");

                 sondeAnalogiqueEntree = new SondeAnalogique(
                        "Sonde Analogique de l'emetteur");
                 sondeAnalogiqueSortie = new SondeAnalogique(
                        "Sonde Analogique du Transmetteur");
                ...
                transmetteurAnalogique.connecter(sondeAnalogiqueSortie);
            }
    ...
    public static void printConsigne() {
        System.out.println("Transmetteur analogique parfaite : \n");
